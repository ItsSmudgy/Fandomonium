...
namespace Fandomonium.Content.Projectiles.BaseProjectileClasses
{
    public abstract class BaseVisualExplosionProjectile : ModProjectile
    {
        ...
        public override string Texture => "Fandomonium/Assets/Textures/BlankSprite";
        ...
        public override void AI()
        {
            ...
            FandomoniumUtils.ExpandProjectileHitbox(Projectile, (int)(CurrentRadius * Projectile.scale), (int)(CurrentRadius * Projectile.scale));
        }
