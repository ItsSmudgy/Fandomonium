...
using Fandomonium.Backgrounds;

namespace Fandomonium.Content
{
    public class TitleScreen : ModMenu
    {
        ...
        public override ModSurfaceBackgroundStyle MenuBackgroundStyle => ModContent.GetInstance<MenuBackgroundStyle>();
        ...
        public override Asset<Texture2D> Logo => ModContent.Request<Texture2D>("Fandomonium/Assets/Textures/Backgrounds/Logo");

        public override int Music => MusicLoader.GetMusicSlot(Mod, "Assets/Music/The-Beginning-of-Fandomonium");

        public override string DisplayName => "Fandomonium";
        ...
        public override bool PreDrawLogo(SpriteBatch spriteBatch, ref Vector2 logoDrawCenter, ref float logoRotation, ref float logoScale, ref Color drawColor)
        {
            ...
            Texture2D backgroundTexture = ModContent.Request<Texture2D>("Fandomonium/Assets/Textures/Backgrounds/Background").Value;
