...
namespace Fandomonium.Content.NPCs.SpiritOfLight.Projectiles
{
    ...
    {
        public override string Texture => "Fandomonium/Assets/Textures/BloomLight";
        ...
        public override void AI()
        {
            ...
            {
                FandomoniumUtils.SpawnProjectileRotatersForProjectile(Projectile.whoAmI, Projectile.width + 50, 2f, ModContent.ProjectileType<GemRingOrbiter>(), Projectile.damage, 8, true);
                if (Main.masterMode)
                {
                    FandomoniumUtils.SpawnProjectileRotatersForProjectile(Projectile.whoAmI, Projectile.width + 100, 2f, ModContent.ProjectileType<GemRingOrbiter>(), Projectile.damage, 8, false);
                }
            }
