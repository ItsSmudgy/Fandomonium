...
using Fandomonium.Common.Utilities;
using Terraria.GameContent;
using Fandomonium.Content.NPCs.SpiritOfLight.Projectiles;
using Fandomonium.Content.Particles;
using Fandomonium.Content.Items.Armor.Vanity;
using Fandomonium.Content.Items;
using Fandomonium.Content.Pets.SpiritOfLightPet;
...
namespace Fandomonium.Content.NPCs.SpiritOfLight
{
    [AutoloadBossHead]
    public class SpiritOfLight : ModNPC
    {
        ...
        public override void SetDefaults()
        {
            ...
            Music = MusicLoader.GetMusicSlot(Mod, "Assets/Music/Crystalline_Warrior");
            NPC.boss = true;
        ...
        {
            npcLoot.Add(ItemDropRule.Common(ModContent.ItemType<Essence_of_Light>()));
            npcLoot.Add(ItemDropRule.Common(ModContent.ItemType<SpiritOfLightTrophy>(), 10));
            npcLoot.Add(ItemDropRule.Common(ModContent.ItemType<SpiritOfLight_Mask>(), 15));
            if (Main.expertMode)
            {
                ;
            }
            ...
            {
                npcLoot.Add(ItemDropRule.BossBag(ModContent.ItemType<SpiritOfLightBag>()));
            }
            if (Main.masterMode)
            {
                ;
            ...
            {
                npcLoot.Add(ItemDropRule.BossBag(ModContent.ItemType<SpiritOfLightBag>()));
                npcLoot.Add(ItemDropRule.Common(ModContent.ItemType<SpiritOfLightPetItem>(), 33));
                npcLoot.Add(ItemDropRule.MasterModeDropOnAllPlayers(ModContent.ItemType<SpiritOfLightRelic>()));
            }
        }
        public override void SetBestiary(BestiaryDatabase database, BestiaryEntry bestiaryEntry)
        {
            bestiaryEntry.Info.AddRange(new List<IBestiaryInfoElement> {
                ...
                new FlavorTextBestiaryInfoElement("A warrior created out of Crystals and Pearlstone, powered by Souls of Light!")
            });
        }
        public override void HitEffect(int hitDirection, double damage)
        {
            ...
            if (NPC.life <= 0)
            {
                ...
                int backGoreType = Mod.Find<ModGore>("SpiritOfLight_Gore").Type;
        ...
        public override void AI()
        {
            ...
            switch (CurrentAttack)
            {
                ...
                case SpiritOfLightAttacks.GemBombs:
                    ...
                    SoundEngine.PlaySound(SoundID.Item159, NPC.Center);
                    break;
                ...
                if (NPC.ai[1] == 0f)
                {
                    ...
                    else
                    {
                        ...
                        if (AttackTimer[1] % time == 0 && Main.netMode != NetmodeID.MultiplayerClient)
                        {
                            ...
                            projVel.Normalize();
                            FandomoniumUtils.NewProjectileBetter(NPC.Center, projVel * projSpeed, ModContent.ProjectileType<GemShot>(), NPC.damage / 2, 0f);
                        }
                    }
                ...
                else
                {
                    ...
                    if (AttackTimer[1] == 0f)
                    {
                        ...
                        if (AttackTimer[2] % 30 == 0 && NPC.localAI[1] < NPC.localAI[0])
                        {
                            ...
                            {
                                /*int num = FandomoniumUtils.NewProjectileBetter(NPC.Bottom, Vector2.Zero, ModContent.ProjectileType<Content.Projectiles.ProjectileRippler>(), NPC.damage / 2, 0f);
                                ...
                                int num2 = FandomoniumUtils.NewProjectileBetter(NPC.Bottom, Vector2.Zero, ModContent.ProjectileType<CrystalShockwave>(), 0, 0f);
                                ...
                                if (phaseTwo)
                                {
                                    if (AttackTimer[0] % timer == 0)
                                    {
                                        ...
                                        for (int i = 0; i < numProj; i++)
                                        {
                                            ...
                                            if (Main.netMode != NetmodeID.MultiplayerClient)
                                            {
                                                FandomoniumUtils.NewProjectileBetter(NPC.Center, vel, ModContent.ProjectileType<PrismaticBolt>(), NPC.damage / 2, 0f);
                                            }
                                        }
                                    }
                                }
        ...
        public void DoRotatingGems(Player player)
        {
            ...
            if (AttackTimer[0] < 60)
            {
                ...
                if (NPC.ai[1] == 0f)
                {
                    ...
                    FandomoniumUtils.SpawnNPCRotatersForNPC(NPC.whoAmI, NPC.width + 35, 4f, ModContent.NPCType<RotatingGem>(), NPC.damage / 2, numberOfGems, Main.rand.NextBool(2));
                }
            }
            ...
            {
                NPC.velocity *= 0.9f;
                FandomoniumUtils.KillNPCs(ModContent.NPCType<RotatingGem>());
            }
        ...
        public void DoGemBombs(Player player, bool phaseTwo)
        {
            ...
            else
            {
                ...
                {
                    FandomoniumUtils.NewProjectileBetter(NPC.Center, Vector2.UnitX.RotatedByRandom(Math.PI * 2f) * Main.rand.NextFloat(2f, 5f), ModContent.ProjectileType<GemBomb>(), NPC.damage, 0f, -1, 0, 180);
                }
            }
        ...
        public void DoSoulBalls(Player player)
        {
            ...
            if (AttackTimer[0] < 60)
            {
                ...
                if (NPC.ai[1] == 0f)
                {
                    ...
                    FandomoniumUtils.SpawnNPCRotatersForNPC(NPC.whoAmI, NPC.width + 35, 1f, ModContent.NPCType<SoulBall>(), NPC.damage / 2, numberOfGems, Main.rand.NextBool(2));
                }
            }
            ...
            {
                NPC.velocity *= 0.9f;
                FandomoniumUtils.KillNPCs(ModContent.NPCType<SoulBall>());
            }
        ...
        public void DoSwordBarrage(Player player, bool phaseTwo)
        {
            ...
            if (AttackTimer[0] > 60 && AttackTimer[0] < 520)
            {
                ...
                if (AttackTimer[0] % 120 == 0 && Main.netMode != NetmodeID.MultiplayerClient)
                {
                    ...
                    {
                        FandomoniumUtils.NewProjectileBetter(NPC.Center, initialVel.RotatedBy((Math.PI / 2) / numProj * i), ModContent.ProjectileType<EnchantedDagger>(), NPC.damage / 2, 0f, default, 20, 40);
                    }
                }
            }
                ...
                if (!Main.dayTime)
                {
                    ...
                    if (type == 1)
                    {
                        ...
                        if (AttackTimer[2] > 30 && AttackTimer[2] < 120 && AttackTimer[1] % attackspeed == 0)
                        {
                            if (Main.netMode != NetmodeID.MultiplayerClient)
                            {
                                for (int i = 0; i < 4; i++)
                                {
                                    FandomoniumUtils.NewProjectileBetter(NPC.Center, Vector2.UnitX.RotatedBy(NPC.localAI[0] + Math.PI * 2 / 4 * i), ModContent.ProjectileType<CelestialStar>(), 50, 0f, ai1: 0.015f);
                                }
                            }
                        }
                        ...
                        if (AttackTimer[1] % 60 == 0)
                        {
                            ...
                            if (Main.netMode != NetmodeID.MultiplayerClient)
                            {
                                for (int i = 0; i < 16; i++)
                                {
                                    FandomoniumUtils.NewProjectileBetter(NPC.Center, Vector2.UnitX.RotatedBy((Math.PI * 2 / 16 * i) + NPC.localAI[1]), ModContent.ProjectileType<CelestialStar>(), 50, 0f, ai1: 0.015f);
                                }
                            }
                        }
                    ...
                    if (type == 2)
                    {
                        ...
                        if (AttackTimer[1] % attackspeed == 0 && Main.netMode != NetmodeID.MultiplayerClient)
                        {
                            ...
                            FandomoniumUtils.NewProjectileBetter(pos, vel, ModContent.ProjectileType<CelestialStarFalling>(), 50, 0f);
                        }
                    ...
                    if (phaseTwo)
                    {
                        ...
                        if (AttackTimer[1] > 80 && AttackTimer[1] < 120 && AttackTimer[0] % 10 == 0)
                        {
                            if (Main.netMode != NetmodeID.MultiplayerClient)
                            {
                                for (int i = 0; i < 4; i++)
                                {
                                    FandomoniumUtils.NewProjectileBetter(NPC.Center, Vector2.UnitX.RotatedBy(NPC.localAI[0] + Math.PI * 2 / 4 * i), ModContent.ProjectileType<PrismaticBolt2>(), 50, 0f, ai1: 0.015f);
                                }
                            }
                        }
                    }
        ...
        public void DoRadiantCrystal(Player player, bool phaseTwo, bool enraged)
        {
            ...
            else
            {
                if (AttackTimer[0] == 60)
                {
                    FandomoniumUtils.NewProjectileBetter(NPC.Center, Vector2.Zero, ModContent.ProjectileType<RadiantGem>(), 100, 0f);
                }
        ...
        public void DoProvidenceBeams(Player player, bool phaseTwo, bool enraged)
        {
            ...
            else
            {
                ...
                if (AttackTimer[0] == 240)
                {
                    int num2 = FandomoniumUtils.NewProjectileBetter(NPC.Center, Vector2.Zero, ModContent.ProjectileType<CrystalShockwave2>(), 0, 0f);
                    if (Main.projectile.IndexInRange(num2))
                    {
                        Main.projectile[num2].ai[1] = 10f;
                    }
                    ...
                    for (int i = -1; i <= 1; i+= 2)
                    {
                        ...
                        int ray = FandomoniumUtils.NewProjectileBetter(NPC.Center, velocity, ModContent.ProjectileType<InsurgencyRay>(), NPC.damage / 2, 0f);
        ...
        private void TryMakingSpike(ref Point sourceTileCoords, int dir, int count, int index, int xOffset, float scale)
        {
            ...
            if (WorldGen.ActiveAndWalkableTile(num2, num3))
            {
                ...
                int num4 = FandomoniumUtils.NewProjectileBetter(position, velocity, ModContent.ProjectileType<CrystalSpike>(), num, 0f);
