	...
	public class CritterCollectorProfile : ITownNPCProfile
	{
		...
		public Asset<Texture2D> GetTextureNPCShouldUse(NPC npc) {
			if (npc.IsABestiaryIconDummy && !npc.ForcePartyHatOn)
				return ModContent.Request<Texture2D>("Fandomonium/Content/NPCs/Critter_Collector");

			if (npc.altTexture == 1)
				return ModContent.Request<Texture2D>("Fandomonium/Content/NPCs/Critter_Collector_Party");

			return ModContent.Request<Texture2D>("Fandomonium/Content/NPCs/Critter_Collector");
		}

		public int GetHeadTextureIndex(NPC npc) => ModContent.GetModHeadSlot("Fandomonium/Content/NPCs/Critter_Collector_Head");
	}
}