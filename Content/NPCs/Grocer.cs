	...
	public class GrocerProfile : ITownNPCProfile
	{
		...
		public Asset<Texture2D> GetTextureNPCShouldUse(NPC npc) {
			if (npc.IsABestiaryIconDummy && !npc.ForcePartyHatOn)
				return ModContent.Request<Texture2D>("Fandomonium/Content/NPCs/Grocer");

			if (npc.altTexture == 1)
				return ModContent.Request<Texture2D>("Fandomonium/Content/NPCs/Grocer_Party");

			return ModContent.Request<Texture2D>("Fandomonium/Content/NPCs/Grocer");
		}

		public int GetHeadTextureIndex(NPC npc) => ModContent.GetModHeadSlot("Fandomonium/Content/NPCs/Grocer_Head");
	}
}