...
{
	public class SpiritOfLightPetProjectile : ModProjectile
	{
		public override void SetStaticDefaults() {
			DisplayName.SetDefault("Spirit Of Light Pet");
		...
		public override void AI() {
			...
			if (!player.dead && player.HasBuff(ModContent.BuffType<SpiritOfLightBuff>())) {
