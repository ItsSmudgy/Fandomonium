...
namespace Fandomonium.Content.Pets.SpiritOfMightPet
{
	public class SpiritOfMightPetItem : ModItem
	{
		public override void SetStaticDefaults() {
			DisplayName.SetDefault("Might Infused Worm");
			Tooltip.SetDefault("Wait where is it's body.");
		...
		public override void SetDefaults() {
			...
			Item.master = true;
			Item.shoot = ModContent.ProjectileType<SpiritOfMightPetProjectile_Head>(); // "Shoot" your pet projectile.
