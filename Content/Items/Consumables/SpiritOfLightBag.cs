...
using Fandomonium.Content.NPCs.SpiritOfLight;
...
namespace Fandomonium.Content.Items.Consumables
{
	// Basic code for a boss treasure bag
	public class SpiritOfLightBag : ModItem
	{
        // Sets the associated NPC this treasure bag is dropped from
        [System.Obsolete]
        public override int BossBagNPC => ModContent.NPCType<SpiritOfLight>();
        ...
        public override void OpenBossBag(Player player) {
			...
			{
				player.QuickSpawnItem(entitySource, ModContent.ItemType<SpiritOfLight_Mask>());
			}
			if (Main.rand.NextBool(10))
			{
				player.QuickSpawnItem(entitySource, ModContent.ItemType<SpiritOfLightTrophy>());
			}
			player.QuickSpawnItem(entitySource, ModContent.ItemType<Essence_of_Light>(), 10);
		}
