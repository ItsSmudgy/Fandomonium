...
using Fandomonium.Content.Items.Weapons;

namespace Fandomonium.Content.Items.Consumables.BossSummons
{
	...
	public class OrbOfLight : ModItem
	{
		public override void SetStaticDefaults() {
			...
			Tooltip.SetDefault("The power of Light in a single orb.");
		...
		public override bool CanUseItem(Player player) {
			...
			return !NPC.AnyNPCs(ModContent.NPCType<SpiritOfLight>());
		}
		...
		public override bool? UseItem(Player player) {
			if (player.whoAmI == Main.myPlayer) {
				...
				int type = ModContent.NPCType<SpiritOfLight>();
