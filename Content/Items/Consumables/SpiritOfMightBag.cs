...
using Fandomonium.Content.NPCs.SpiritOfMight;
...
namespace Fandomonium.Content.Items.Consumables
{
	...
	public class SpiritOfMightBag : ModItem
	{
        ...
        [System.Obsolete]
        public override int BossBagNPC => ModContent.NPCType<SpiritOfMight_Head>();
        ...
        public override void OpenBossBag(Player player) {
			...
			if (Main.rand.NextBool(7)) {
				player.QuickSpawnItem(entitySource, ModContent.ItemType<SpiritOfMight_Mask>());
			}
			if (Main.rand.NextBool(10))
			{
				player.QuickSpawnItem(entitySource, ModContent.ItemType<SpiritOfMightTrophy>());
			}
				player.QuickSpawnItem(entitySource, ModContent.ItemType<Essence_of_Might>(), 10);
		}
