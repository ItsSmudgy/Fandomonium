...
namespace Fandomonium.Content.Tiles.Relics
{
	...
	public class SpiritOfLightRelic : ModTile
	{
		...
		public virtual string RelicTextureName => "Fandomonium/Content/Tiles/Relics/SpiritOfLightRelic";

		// All relics use the same pedestal texture, this one is copied from vanilla
		public override string Texture => "Fandomonium/Content/Tiles/Relics/RelicPedestal";
		...
		public override void KillMultiTile(int i, int j, int frameX, int frameY) {
			...
			switch (placeStyle) {
				case 0:
					itemType = ModContent.ItemType<Items.Placeable.Relics.SpiritOfMightRelic>();
					break;
